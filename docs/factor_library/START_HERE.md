...
- `python scripts/apply_crypto_industry_taxonomy_review_packet.py --source-csv data/sources/crypto_industry_taxonomy_contract_v1/symbol_taxonomy.csv --packet-csv research/factor_runs/crypto_top50_factor_library/factor_diagnostics/industry_taxonomy_review_batch_001.csv --packet-csv research/factor_runs/crypto_top50_factor_library/factor_diagnostics/industry_taxonomy_review_batch_002.csv --output-csv /tmp/symbol_taxonomy.reviewed.csv`
