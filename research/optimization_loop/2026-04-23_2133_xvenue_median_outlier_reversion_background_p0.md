...
- 这条线与既有 cross-venue spread-close / XEMM 家族高度重叠，更像执行壳 / router 提示，而不是新的独立 after-fee alpha。

## Result
`cross-venue median outlier reversion`：已完成最小 honesty 检查，当前只应收口为 `background/P0`，不进入 survivor。
