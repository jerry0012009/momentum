...
1. `2026-03-24_1130_strategy-review.md`
   - 已把主资源继续放在 `Rank 154` 的 `P2 exit decision`。
2. `2026-03-24_1119_strategy-review.md`
...
- 原因：
  ...
  - 剩余问题已经收缩到 exit decision：优先用 `cross-asset / parameter / effectiveness` 收口，再决定 `P3` 还是 `P0`。
...
- 新增：`/root/clawd/jerry/momentum/research/strategy_review/2026-03-24_1145_strategy-review.md`
