...
BACKFILL_STATUSES = {
    ...
    "already_registered",
    "implemented_alpha101_ohlcv_batch_01",
    "implemented_alpha101_ohlcv_batch_02",
    "implemented_alpha101_panel_batch_03",
}
...
def test_public_manifest_counts_and_batch_sizes(rows: list[dict[str, str]]) -> None:
    ...
    assert implemented_counts == {"alpha101": 25, "alpha158": 95}
    assert total_counts == {"alpha101": 31, "alpha158": 101}
