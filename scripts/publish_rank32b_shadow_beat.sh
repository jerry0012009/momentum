...
SRC_SITE="$ROOT/reports/site/factors/rank32b_shadow_beat"
SRC_ART="$ROOT/reports/artifacts/rank32b_shadow_beat"

DST_ROOT="/var/www/momentum-report"
DST_SITE="$DST_ROOT/factors/rank32b_shadow_beat"
DST_ART="$DST_ROOT/artifacts/rank32b_shadow_beat"
...
echo "[ok] published rank32b_shadow_beat -> $DST_SITE"
