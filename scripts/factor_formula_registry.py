...
REGISTRY: list[FactorSpec] = [
    ...
    FactorSpec(
        ...
        expected_direction="conditional",
        status="DIAGNOSTIC_PROBE",
        notes="rolling_min(ts_alpha(volume, cap, 80), 80); volume-cap relation; requires 'cap' column; migrated from alpha101 volume_cap_alpha_min_20_20",
        compute_scope="panel",
    ...
    FactorSpec(
        ...
        expected_direction="conditional",
        status="DIAGNOSTIC_PROBE",
        notes="rolling_min(ts_alpha(volume, cap, 56), 84); faster volume-cap relation; requires 'cap' column; migrated from alpha101 volume_cap_alpha_min_14_21",
        compute_scope="panel",
