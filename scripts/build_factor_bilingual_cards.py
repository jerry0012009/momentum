...
FACTOR_NAMES: dict[str, tuple[str, str]] = {
    ...
    "wq101_alpha1": ("WQ101 Alpha1 Return-Vol Argmax Rank", "WQ101 Alpha1 收益波动最高位置排名"),
    "wq101_alpha2": ("WQ101 Alpha2 Volume Delta Intrabar Corr", "WQ101 Alpha2 成交量变化K线内相关"),
    "wq101_alpha3": ("WQ101 Alpha3 Open-Volume Rank Corr", "WQ101 Alpha3 开盘成交量排名相关"),
    "wq101_alpha4": ("WQ101 Alpha4 Low Rank Time Rank", "WQ101 Alpha4 最低价排名时序排名"),
    "wq101_alpha5": ("WQ101 Alpha5 Open VWAP / Close VWAP Rank", "WQ101 Alpha5 开盘VWAP收盘VWAP排名"),
    "wq101_alpha7": ("WQ101 Alpha7 Relative Volume Delta Rank", "WQ101 Alpha7 相对成交量价格变化排名"),
    "wq101_alpha8": ("WQ101 Alpha8 Open Return Sum Rank", "WQ101 Alpha8 开盘收益和排名"),
    "wq101_alpha10": ("WQ101 Alpha10 Conditional Delta Rank", "WQ101 Alpha10 条件价格变化排名"),
    "wq101_alpha11": ("WQ101 Alpha11 VWAP Spread Volume Rank", "WQ101 Alpha11 VWAP价差成交量排名"),
    "wq101_alpha13": ("WQ101 Alpha13 Close-Volume Rank Cov", "WQ101 Alpha13 收盘成交量排名协方差"),
    "wq101_alpha14": ("WQ101 Alpha14 Return Delta Open-Volume Corr", "WQ101 Alpha14 收益变化开盘成交量相关"),
    "wq101_alpha15": ("WQ101 Alpha15 High-Volume Rank Corr Sum", "WQ101 Alpha15 高价成交量排名相关和"),
    "wq101_alpha16": ("WQ101 Alpha16 High-Volume Rank Cov", "WQ101 Alpha16 高价成交量排名协方差"),
    "wq101_alpha17": ("WQ101 Alpha17 Close / Relative Volume Rank", "WQ101 Alpha17 收盘相对成交量排名"),
    "wq101_alpha18": ("WQ101 Alpha18 Candle Spread Corr Rank", "WQ101 Alpha18 K线价差相关排名"),
    "wq101_alpha19": ("WQ101 Alpha19 Long Return State Rank", "WQ101 Alpha19 长收益状态排名"),
    "wq101_alpha20": ("WQ101 Alpha20 Open Gap Triple Rank", "WQ101 Alpha20 开盘缺口三重排名"),
    "wq101_alpha22": ("WQ101 Alpha22 High-Volume Corr Delta", "WQ101 Alpha22 高价成交量相关变化"),
    "wq101_alpha26": ("WQ101 Alpha26 Ranked Volume-High Corr Max", "WQ101 Alpha26 成交量高价排名相关最大值"),
    "wq101_alpha27": ("WQ101 Alpha27 VWAP-Volume Corr Gate", "WQ101 Alpha27 VWAP成交量相关门控"),
    "wq101_alpha29": ("WQ101 Alpha29 Nested Close Delta Rank", "WQ101 Alpha29 嵌套收盘变化排名"),
    "wq101_alpha31": ("WQ101 Alpha31 Decayed Delta ADV-Low Rank", "WQ101 Alpha31 衰减价格变化均量低价排名"),
    "wq101_alpha36": ("WQ101 Alpha36 Weighted Candle Volume Blend", "WQ101 Alpha36 加权K线成交量混合"),
    "wq101_alpha39": ("WQ101 Alpha39 Relative Volume Return Rank", "WQ101 Alpha39 相对成交量收益排名"),
    "wq101_alpha56": ("WQ101 Alpha56 Return-Cap Rank Product", "WQ101 Alpha56 收益市值排名乘积"),
    "wq101_alpha57": ("WQ101 Alpha57 Close VWAP Argmax Decay", "WQ101 Alpha57 收盘VWAP最高位置衰减"),
    "wq101_alpha62": ("WQ101 Alpha62 VWAP ADV OHLC Gate", "WQ101 Alpha62 VWAP均量OHLC门控"),
    "wq101_alpha64": ("WQ101 Alpha64 Open Low ADV Blend Gate", "WQ101 Alpha64 开盘低价均量混合门控"),
    "wq101_alpha66": ("WQ101 Alpha66 VWAP Delta Location Rank", "WQ101 Alpha66 VWAP变化位置排名"),
    "wq101_alpha71": ("WQ101 Alpha71 Dual Decayed Rank Max", "WQ101 Alpha71 双衰减排名最大值"),
    "wq101_alpha72": ("WQ101 Alpha72 Mid ADV / VWAP Volume Ratio", "WQ101 Alpha72 中价均量与VWAP成交量比"),
    "wq101_alpha73": ("WQ101 Alpha73 VWAP Blend Decay Max", "WQ101 Alpha73 VWAP混合衰减最大值"),
    "wq101_alpha81": ("WQ101 Alpha81 ADV VWAP Product Gate", "WQ101 Alpha81 均量VWAP乘积门控"),
    "wq101_alpha84": ("WQ101 Alpha84 VWAP Max Signed Power", "WQ101 Alpha84 VWAP最高差符号幂"),
    "wq101_alpha96": ("WQ101 Alpha96 Dual Decayed Correlation Max", "WQ101 Alpha96 双衰减相关最大值"),
    "wq101_alpha98": ("WQ101 Alpha98 VWAP ADV Minus Open ADV", "WQ101 Alpha98 VWAP均量减开盘均量"),
    ...
    "wq101_alpha25": ("WQ101 Alpha25 Return-ADV VWAP Rank", "WQ101 Alpha25 收益均量VWAP排名"),
    "wq101_alpha28": ("WQ101 Alpha28 ADV-Low Corr Scale", "WQ101 Alpha28 均量低价相关缩放"),
    "wq101_alpha30": ("WQ101 Alpha30 Delta-Sign Volume Ratio", "WQ101 Alpha30 价格符号成交量比"),
    "wq101_alpha35": ("WQ101 Alpha35 Volume / Price TS Rank", "WQ101 Alpha35 成交量价格时序排名"),
    "wq101_alpha43": ("WQ101 Alpha43 Relative Volume Delta Rank", "WQ101 Alpha43 相对成交量价格变化排名"),
    "wq101_alpha52": ("WQ101 Alpha52 Low Break / Return Rank", "WQ101 Alpha52 低价变化收益排名"),
    "wq101_alpha47": ("WQ101 Alpha47 Inverse Price VWAP Rank", "WQ101 Alpha47 价格倒数VWAP排名"),
    "wq101_alpha61": ("WQ101 Alpha61 VWAP / ADV Corr Gate", "WQ101 Alpha61 VWAP均量相关门控"),
    "wq101_alpha65": ("WQ101 Alpha65 Open VWAP ADV Gate", "WQ101 Alpha65 开盘VWAP均量门控"),
    "wq101_alpha68": ("WQ101 Alpha68 High ADV / Price Gate", "WQ101 Alpha68 高价均量价格门控"),
    "wq101_alpha74": ("WQ101 Alpha74 Close ADV / High VWAP Gate", "WQ101 Alpha74 收盘均量高价VWAP门控"),
    "wq101_alpha75": ("WQ101 Alpha75 VWAP Volume / Low ADV Gate", "WQ101 Alpha75 VWAP成交量低价均量门控"),
    "wq101_alpha77": ("WQ101 Alpha77 Decayed Mid VWAP Minimum", "WQ101 Alpha77 衰减中价VWAP最小值"),
    "wq101_alpha78": ("WQ101 Alpha78 Low VWAP ADV Power Corr", "WQ101 Alpha78 低价VWAP均量幂相关"),
    "wq101_alpha83": ("WQ101 Alpha83 Range VWAP Volume Ratio", "WQ101 Alpha83 区间VWAP成交量比"),
    "wq101_alpha85": ("WQ101 Alpha85 High Close ADV Power Corr", "WQ101 Alpha85 高价收盘均量幂相关"),
    "wq101_alpha86": ("WQ101 Alpha86 Close ADV VWAP Gate", "WQ101 Alpha86 收盘均量VWAP门控"),
    "wq101_alpha88": ("WQ101 Alpha88 Decayed OHLC ADV Rank", "WQ101 Alpha88 衰减OHLC均量排名"),
    "wq101_alpha92": ("WQ101 Alpha92 Decayed Candle ADV Gate", "WQ101 Alpha92 衰减K线均量门控"),
    "wq101_alpha94": ("WQ101 Alpha94 VWAP ADV Power Rank", "WQ101 Alpha94 VWAP均量幂排名"),
    "wq101_alpha95": ("WQ101 Alpha95 Open ADV Correlation Gate", "WQ101 Alpha95 开盘均量相关门控"),
    "wq101_alpha99": ("WQ101 Alpha99 Mid ADV Low Volume Gate", "WQ101 Alpha99 中价均量低价成交门控"),
...
FACTOR_FORMULAS: dict[str, tuple[str, str]] = {
    ...
    "wq101_alpha1": ("rank(ts_argmax(signedpower(where(returns<0,stddev(returns,20),close),2),5))-0.5", "rank(5期内收益为负时用20期波动、否则用收盘价平方后的最高位置) - 0.5"),
    "wq101_alpha2": ("-corr(rank(delta(log(volume),2)), rank((close-open)/open), 6)", "-corr(rank(log成交量2期变化), rank((收盘-开盘)/开盘), 6)"),
    "wq101_alpha3": ("-corr(rank(open), rank(volume), 10)", "-corr(rank(开盘价), rank(成交量), 10)"),
    "wq101_alpha4": ("-ts_rank(rank(low), 9)", "-ts_rank(rank(最低价), 9)"),
    "wq101_alpha5": ("rank(open-mean(vwap,10)) * -abs(rank(close-vwap))", "rank(开盘价-10期VWAP均值) * -abs(rank(收盘价-VWAP))"),
    "wq101_alpha7": ("where(adv20<volume, -ts_rank(abs(delta(close,7)),60)*sign(delta(close,7)), -1)", "当成交量高于20期均量时：-ts_rank(abs(7期收盘变化),60)*sign(7期收盘变化)，否则 -1"),
    "wq101_alpha8": ("-rank(sum(open,5)*sum(returns,5)-delay(sum(open,5)*sum(returns,5),10))", "-rank(5期开盘和*5期收益和 - 10期前同项)"),
    "wq101_alpha10": ("rank(where(ts_min(delta(close,1),4)>0,delta,where(ts_max(delta(close,1),4)<0,delta,-delta)))", "rank(按4期价格变化极值选择同向或反向的一期收盘变化)"),
    "wq101_alpha11": ("(rank(ts_max(vwap-close,3))+rank(ts_min(vwap-close,3)))*rank(delta(volume,3))", "(rank(3期最大VWAP-收盘差)+rank(3期最小VWAP-收盘差))*rank(3期成交量变化)"),
    "wq101_alpha13": ("-rank(covariance(rank(close), rank(volume), 5))", "-rank(5期rank(收盘价)与rank(成交量)协方差)"),
    "wq101_alpha14": ("-rank(delta(returns,3)) * corr(open, volume, 10)", "-rank(收益3期变化) * corr(开盘价, 成交量, 10)"),
    "wq101_alpha15": ("-sum(rank(corr(rank(high),rank(volume),3)),3)", "-sum(rank(corr(rank(最高价),rank(成交量),3)),3)"),
    "wq101_alpha16": ("-rank(covariance(rank(high), rank(volume), 5))", "-rank(5期rank(最高价)与rank(成交量)协方差)"),
    "wq101_alpha17": ("-rank(ts_rank(close,10))*rank(delta(delta(close,1),1))*rank(ts_rank(volume/adv20,5))", "-rank(收盘10期时序排名)*rank(收盘变化的变化)*rank(成交量/20期均量的5期排名)"),
    "wq101_alpha18": ("-rank(stddev(abs(close-open),5)+(close-open)+corr(close,open,10))", "-rank(5期abs(收盘-开盘)波动 + 收开差 + 收盘开盘10期相关)"),
    "wq101_alpha19": ("-sign((close-delay(close,7))+delta(close,7))*(1+rank(1+sum(returns,250)))", "-sign(7期收盘变化状态)*(1+rank(1+250期收益和))"),
    "wq101_alpha20": ("-rank(open-delay(high,1))*rank(open-delay(close,1))*rank(open-delay(low,1))", "-rank(开盘-前高)*rank(开盘-前收)*rank(开盘-前低)"),
    "wq101_alpha22": ("-delta(corr(high,volume,5),5)*rank(stddev(close,20))", "-5期高价成交量相关变化 * rank(收盘20期波动)"),
    "wq101_alpha26": ("-ts_max(corr(ts_rank(volume,5),ts_rank(high,5),5),3)", "-3期最大值(corr(成交量5期排名, 最高价5期排名, 5))"),
    "wq101_alpha27": ("where(rank(mean(corr(rank(volume),rank(vwap),6),2))>0.5,-1,1)", "若rank(2期平均成交量/VWAP排名相关)>0.5则 -1，否则 1"),
    "wq101_alpha29": ("min(rank(rank(scale(log(ts_min(rank(rank(-rank(delta(close,5))),2))))),5)+ts_rank(delay(-returns,6),5)", "嵌套收盘5期变化排名的缩放最小值 + 延迟负收益的5期时序排名"),
    "wq101_alpha31": ("rank(rank(rank(decay_linear(-rank(rank(delta(close,10))),10))))+rank(-delta(close,3))+sign(scale(corr(adv20,low,12)))", "三重rank的衰减10期收盘变化 + 负3期变化排名 + adv20与最低价相关的scale符号"),
    "wq101_alpha36": ("weighted ranks of candle-volume corr, open-close spread, delayed negative returns, VWAP/ADV corr, and mean-close state", "K线成交量相关、开收差、延迟负收益、VWAP/均量相关、均值收盘状态的加权排名和"),
    "wq101_alpha39": ("-rank(delta(close,7)*(1-rank(decay_linear(volume/adv20,9))))*(1+rank(sum(returns,250)))", "-rank(7期收盘变化 * (1-rank(成交量/adv20衰减))) * (1+rank(250期收益和))"),
    "wq101_alpha56": ("-rank(sum(returns,10)/sum(sum(returns,2),3))*rank(returns*cap)", "-rank(10期收益和 / 3期的2期收益和之和) * rank(收益 * 市值)"),
    "wq101_alpha57": ("-(close-vwap)/decay_linear(rank(ts_argmax(close,30)),2)", "-(收盘价-VWAP) / rank(30期最高位置)的2期线性衰减"),
    "wq101_alpha62": ("-1*(rank(corr(vwap,sum(adv20,22),10)) < rank(rank(open)+rank(open) < rank(mid)+rank(high)))", "-1*(VWAP与adv20和相关排名 < OHLC截面排名条件)"),
    "wq101_alpha64": ("-1*(rank(corr(sum(open/low blend,13),sum(adv120,13),17)) < rank(delta(mid/vwap blend,4)))", "-1*(开盘/低价混合与adv120和相关排名 < 中价/VWAP混合4期变化排名)"),
    "wq101_alpha66": ("-1*(rank(decay_linear(delta(vwap,4),7))+ts_rank(decay_linear((low-vwap)/(open-mid),11),7))", "-1*(VWAP 4期变化衰减排名 + K线位置比率衰减后的7期时序排名)"),
    "wq101_alpha71": ("max(ts_rank(decayed corr(ts_rank(close,3),ts_rank(adv180,12)),16), ts_rank(decayed rank(low+open-2*vwap)^2,4))", "max(收盘/adv180相关衰减时序排名, low+open-2*VWAP 排名平方的衰减时序排名)"),
    "wq101_alpha72": ("rank(decayed corr(mid,adv40,9)) / rank(decayed corr(ts_rank(vwap,4),ts_rank(volume,19),7))", "中价与adv40相关的衰减排名 / VWAP时序排名与成交量时序排名相关的衰减排名"),
    "wq101_alpha73": ("-max(rank(decayed delta(vwap,5)), ts_rank(decayed negative open/low blend change ratio,17))", "-max(VWAP变化衰减排名, 开盘/低价混合变化率负值衰减后的时序排名)"),
    "wq101_alpha81": ("-1*(rank(log(product(rank(rank(corr(vwap,sum(adv10,50),8))^4),15))) < rank(corr(rank(vwap),rank(volume),5)))", "-1*(VWAP与adv10和相关的排名乘积 < VWAP/成交量排名相关)"),
    "wq101_alpha84": ("signedpower(ts_rank(vwap-ts_max(vwap,15),21), delta(close,5))", "以5期收盘变化为指数，对VWAP减15期最高VWAP的21期时序排名做符号幂"),
    "wq101_alpha96": ("-max(ts_rank(decayed corr(rank(vwap),rank(volume))), ts_rank(decayed argmax corr(ts_rank(close),ts_rank(adv60))))", "-max(VWAP/成交量排名相关衰减时序排名, 收盘/adv60相关最高位置衰减时序排名)"),
    "wq101_alpha98": ("rank(decayed corr(vwap,sum(adv5,26))) - rank(decayed ts_rank(ts_argmin(corr(rank(open),rank(adv15)))))", "VWAP与adv5和相关的衰减排名 - 开盘与adv15排名相关最低位置的衰减排名"),
    ...
    "wq101_alpha25": ("rank((-returns * adv20 * vwap) * (high-close))", "rank((-收益 * 20期均量 * VWAP) * (最高价-收盘价))"),
    "wq101_alpha28": ("scale(corr(adv20,low,5) + ((high+low)/2) - close)", "scale(20期均量与最低价5期相关 + 高低价中点 - 收盘价)"),
    "wq101_alpha30": ("((1-rank(sign(delta(close))+sign(delay(delta(close),1))+sign(delay(delta(close),2))))*sum(volume,5))/sum(volume,20)", "((1-rank(近3期价格变化符号和))*5期成交量和)/20期成交量和"),
    "wq101_alpha35": ("ts_rank(volume,32) * (1-ts_rank(close+high-low,16)) * (1-ts_rank(returns,32))", "成交量32期时序排名 * (1-价格形态16期排名) * (1-收益32期排名)"),
    "wq101_alpha43": ("ts_rank(volume/adv20,20) * ts_rank(-delta(close,7),8)", "成交量/20期均量的20期排名 * -7期收盘变化的8期排名"),
    "wq101_alpha52": ("-delta(ts_min(low,5),5) * rank((sum(returns,240)-sum(returns,20))/220) * ts_rank(volume,5)", "-5期最低价变化 * rank(长短收益和差) * 成交量5期排名"),
    "wq101_alpha47": ("rank(1/close)*volume/adv20*high*rank(high-close)/(sum(high,5)/5)-rank(delta(vwap,5))", "rank(1/收盘价)*成交量/20期均量*最高价*rank(最高-收盘)/(5期最高均值)-rank(VWAP 5期变化)"),
    "wq101_alpha61": ("rank(vwap-ts_min(vwap,16)) < rank(corr(vwap,adv180,18))", "rank(VWAP-16期最低VWAP) < rank(VWAP与180期均量18期相关)"),
    "wq101_alpha65": ("-1*(rank(corr(open/vwap blend,sum(adv60,9),6)) < rank(open-ts_min(open,14)))", "-1*(rank(开盘/VWAP混合与adv60和的相关) < rank(开盘-14期最低开盘))"),
    "wq101_alpha68": ("-1*(ts_rank(corr(rank(high),rank(adv15),9),14) < rank(delta(close/low blend,1)))", "-1*(高价与15期均量排名相关的14期排名 < rank(收盘/最低混合的一期变化))"),
    "wq101_alpha74": ("-1*(rank(corr(close,sum(adv30,37),15)) < rank(corr(rank(high/vwap blend),rank(volume),11)))", "-1*(rank(收盘与adv30和的相关) < rank(高价/VWAP混合排名与成交量排名相关))"),
    "wq101_alpha75": ("rank(corr(vwap,volume,4)) < rank(corr(rank(low),rank(adv50),12))", "rank(VWAP与成交量4期相关) < rank(最低价排名与50期均量排名12期相关)"),
    "wq101_alpha77": ("min(rank(decay_linear(mid-vwap,20)), rank(decay_linear(corr(mid,adv40,3),6)))", "min(rank(中价-VWAP的20期线性衰减), rank(中价与40期均量相关的衰减))"),
    "wq101_alpha78": ("rank(corr(sum(low/vwap blend,20),sum(adv40,20),7)) ^ rank(corr(rank(vwap),rank(volume),6))", "rank(低价/VWAP混合和与adv40和的相关) ^ rank(VWAP排名与成交量排名相关)"),
    "wq101_alpha83": ("rank(delay(range/avg_close,2))*rank(rank(volume)) / ((range/avg_close)/(vwap-close))", "rank(延迟区间/均价)*rank(rank(成交量)) / ((区间/均价)/(VWAP-收盘))"),
    "wq101_alpha85": ("rank(corr(high/close blend,adv30,10)) ^ rank(corr(ts_rank(mid,4),ts_rank(volume,10),7))", "rank(高价/收盘混合与30期均量相关) ^ rank(中价时序排名与成交量时序排名相关)"),
    "wq101_alpha86": ("-1*(ts_rank(corr(close,sum(adv20,15),6),20) < rank(close-vwap))", "-1*(收盘与adv20和相关的20期排名 < rank(收盘-VWAP))"),
    "wq101_alpha88": ("min(rank(decay_linear(rank(open)+rank(low)-rank(high)-rank(close),8)), ts_rank(decay_linear(corr(ts_rank(close,8),ts_rank(adv60,21),8),7),3))", "min(衰减OHLC截面排名差, 衰减收盘排名与60期均量排名相关的时序排名)"),
    "wq101_alpha92": ("min(ts_rank(decay_linear(mid+close < low+open,15),19), ts_rank(decay_linear(corr(rank(low),rank(adv30),8),7),7))", "min(衰减K线条件的时序排名, 低价排名与30期均量排名相关的衰减时序排名)"),
    "wq101_alpha94": ("-rank(vwap-ts_min(vwap,12)) ^ ts_rank(corr(ts_rank(vwap,20),ts_rank(adv60,4),18),3)", "-rank(VWAP-12期最低VWAP) ^ VWAP排名与60期均量排名相关的3期排名"),
    "wq101_alpha95": ("rank(open-ts_min(open,12)) < ts_rank(rank(corr(sum(mid,19),sum(adv40,19),13))^5,12)", "rank(开盘-12期最低开盘) < 中价和与adv40和相关排名五次方的12期排名"),
    "wq101_alpha99": ("-1*(rank(corr(sum(mid,20),sum(adv60,20),9)) < rank(corr(low,volume,6)))", "-1*(rank(中价和与adv60和相关) < rank(最低价与成交量相关))"),
...
FACTOR_LIMITATIONS: dict[str, tuple[str, str]] = {
    ...
    "wq101_alpha1": ("Uses nested return volatility, signed power and argmax rank; interpretation depends on the local ts_argmax convention.", "使用嵌套收益波动、符号幂和最高位置排名；解释依赖本地ts_argmax约定。"),
    "wq101_alpha2": ("Short rolling correlation of ranked log-volume delta and intrabar return can be noisy around volume spikes.", "排名后的log成交量变化与K线内收益短窗口相关在放量附近可能噪音较大。"),
    "wq101_alpha3": ("Pure open-volume rank correlation is highly universe-dependent and can overlap liquidity factors.", "纯开盘价-成交量排名相关高度依赖币种池，可能与流动性因子重叠。"),
    "wq101_alpha4": ("Time-series rank of cross-sectional low rank can become sticky in persistent trend regimes.", "最低价截面排名的时序排名在持续趋势中可能较粘滞。"),
    "wq101_alpha5": ("VWAP derives from quote_volume/volume; cross-sectional ranks make the output sensitive to universe composition.", "VWAP由成交额/成交量推导；截面排名使输出受币种池组成影响。"),
    "wq101_alpha7": ("Relative-volume gate emits a hard -1 fallback and has a 67-bar warmup, so early coverage and discrete states need review.", "相对成交量门控会输出硬 -1 分支且启动期约67根K线，需复核早期覆盖和离散状态。"),
    "wq101_alpha8": ("Open and return rolling sums mix price scale with returns; cross-sectional rank can be dominated by high-price names.", "开盘价和收益滚动和混合了价格尺度与收益；截面排名可能受高价格标的主导。"),
    "wq101_alpha10": ("Conditional close-delta rank uses hard trend-state branches and can flip in choppy markets.", "条件收盘变化排名使用硬趋势状态分支，在震荡行情中可能频繁翻转。"),
    "wq101_alpha11": ("Combines short VWAP-close extrema and volume delta rank; sensitive to tiny VWAP-close differences.", "结合短窗口VWAP-收盘差极值和成交量变化排名，对很小的VWAP-收盘差敏感。"),
    "wq101_alpha13": ("Rolling covariance of ranked close and volume is expected to be redundancy-prone with volume-correlation families.", "排名后收盘价与成交量的滚动协方差预期会与量价相关类因子存在冗余。"),
    "wq101_alpha14": ("Combines short return acceleration rank with open-volume correlation; can overlap momentum and liquidity families.", "结合短期收益加速度排名与开盘成交量相关，可能与动量和流动性因子重叠。"),
    "wq101_alpha15": ("Nested ranked high-volume correlations are short-window and universe-composition sensitive.", "嵌套高价-成交量排名相关窗口很短，且对币种池组成敏感。"),
    "wq101_alpha16": ("High-volume rank covariance is expected to be redundancy-prone with Alpha13 and volume-correlation families.", "高价-成交量排名协方差预期会与Alpha13及量价相关类因子冗余。"),
    "wq101_alpha17": ("Triple rank product mixes close rank, close acceleration, and relative volume; sparse histories need warmup review.", "三重排名乘积混合收盘排名、价格加速度和相对成交量；短历史标的需复核启动期。"),
    "wq101_alpha18": ("Candle spread plus open-close correlation can be dominated by bar microstructure and opening gaps.", "K线价差叠加开收相关可能受K线微观结构和开盘缺口主导。"),
    "wq101_alpha19": ("Uses a 250-bar return sum and a hard sign branch; slow to initialize and regime-dependent.", "使用250期收益和及硬符号分支，启动慢且依赖市场状态。"),
    "wq101_alpha20": ("Triple open-gap ranks are sensitive to previous-bar wick noise and cross-sectional universe membership.", "三重开盘缺口排名对前一根K线影线噪音和截面币种池敏感。"),
    "wq101_alpha22": ("Correlation delta multiplied by volatility rank can be unstable around volume shocks and volatility spikes.", "相关性变化乘以波动排名，在成交量冲击和波动尖峰附近可能不稳定。"),
    "wq101_alpha26": ("Nested time-series ranks and rolling max can be sticky and overlap high-volume correlation factors.", "嵌套时序排名和滚动最大值可能较粘滞，并与高价成交量相关因子重叠。"),
    "wq101_alpha27": ("Boolean VWAP-volume correlation gate is discrete and rank-threshold sensitive.", "VWAP-成交量相关布尔门控是离散输出，且对排名阈值敏感。"),
    "wq101_alpha29": ("Nested ranks and log/scale transforms are highly universe-composition sensitive and can compress variation.", "嵌套排名和log/scale变换高度依赖币种池组成，并可能压缩差异。"),
    "wq101_alpha31": ("Combines decayed close-delta ranks with an ADV-low correlation sign; output can flip around low-volume regimes.", "结合衰减收盘变化排名和均量-低价相关符号，低成交量状态附近可能翻转。"),
    "wq101_alpha36": ("Weighted multi-branch formula has a 200-bar warmup and high redundancy risk with candle, return, and volume families.", "多分支加权公式有200期启动期，且与K线、收益、成交量族存在高冗余风险。"),
    "wq101_alpha39": ("Uses a 250-bar return sum and relative-volume decay; slow to initialize and regime dependent.", "使用250期收益和及相对成交量衰减，启动慢且依赖市场状态。"),
    "wq101_alpha56": ("Requires the point-in-time market-cap panel; cross-sectional ranks are universe-sensitive and cap coverage gaps can remove newer symbols.", "需要点时市值面板；截面排名受币种池影响，市值覆盖缺口会剔除部分新上市标的。"),
    "wq101_alpha57": ("Division by a decayed argmax rank can amplify small VWAP-close differences.", "除以衰减最高位置排名会放大小的VWAP-收盘差异。"),
    "wq101_alpha62": ("Boolean VWAP/ADV versus OHLC rank gate is discrete and sensitive to tied cross-sectional ranks.", "VWAP/均量与OHLC排名门控是离散输出，对截面排名并列敏感。"),
    "wq101_alpha64": ("Long ADV120 warmup and blended price delta make coverage and interpretation sensitive to listing history.", "较长adv120启动期和混合价格变化使覆盖与解释依赖上市历史。"),
    "wq101_alpha66": ("Intrabar-location denominator can be small around mid-price opens, producing extreme diagnostic values.", "开盘接近中价时K线位置分母可能很小，产生极端诊断值。"),
    "wq101_alpha71": ("Dual decayed branches with adv180 create a long warmup and may be sticky across regime shifts.", "双衰减分支叠加adv180导致长启动期，市场状态切换后可能较粘滞。"),
    "wq101_alpha72": ("Ratio of rank branches can be unstable when denominator rank is small and may overlap VWAP-volume families.", "排名分支比值在分母排名较小时不稳定，并可能与VWAP成交量族冗余。"),
    "wq101_alpha73": ("Max of two decayed rank branches is universe-sensitive and can overlap VWAP momentum diagnostics.", "两个衰减排名分支取最大值，对币种池敏感，并可能与VWAP动量诊断重叠。"),
    "wq101_alpha81": ("Boolean product/log gate is discrete and can be fragile when ranked correlation products approach zero.", "乘积/log布尔门控是离散输出，排名相关乘积接近零时可能较脆弱。"),
    "wq101_alpha84": ("Signed-power exponent uses close delta, so small VWAP-rank bases can compress or amplify values sharply.", "符号幂指数来自收盘变化，小的VWAP排名底数可能明显压缩或放大取值。"),
    "wq101_alpha96": ("Nested decay, argmax and ADV60 branches have a long warmup and high redundancy risk with VWAP-volume families.", "嵌套衰减、最高位置和adv60分支启动期较长，且与VWAP成交量族有较高冗余风险。"),
    "wq101_alpha98": ("Difference of two decayed rank-correlation branches is sensitive to rolling argmin convention and ADV warmups.", "两个衰减排名相关分支之差对滚动最低位置约定和ADV启动期敏感。"),
    ...
    "wq101_alpha25": ("Combines return, ADV, VWAP and intrabar close gap; scale can be dominated by high-volume names.", "结合收益、均量、VWAP和K线内收盘缺口；尺度可能被高成交量标地主导。"),
    "wq101_alpha28": ("ADV-low correlation and cross-sectional scale are sensitive to universe membership and low-liquidity bars.", "均量与最低价相关及截面缩放对币种池组成和低流动性K线敏感。"),
    "wq101_alpha30": ("Uses discrete close-delta signs and volume ratios; many tied sign states can reduce rank resolution.", "使用离散价格变化符号和成交量比；大量相同符号状态会降低排名分辨率。"),
    "wq101_alpha35": ("Triple time-series ranks can be slow to warm up and may be redundant with volume/return rank families.", "三重时序排名启动较慢，并可能与成交量/收益排名族冗余。"),
    "wq101_alpha43": ("Relative-volume and close-delta ranks use nested warmups; sparse symbols can have delayed coverage.", "相对成交量和价格变化排名有嵌套启动期；稀疏标的覆盖可能滞后。"),
    "wq101_alpha52": ("Long 240-bar return window makes the factor slow to initialize and regime dependent.", "240期长收益窗口使因子启动慢且依赖市场状态。"),
    "wq101_alpha47": ("Combines inverse price, ADV ratio, high-close gap, and VWAP delta rank; scale can be dominated by price level effects.", "结合价格倒数、均量比、高收差和VWAP变化排名；尺度可能受价格水平影响。"),
    "wq101_alpha61": ("Boolean comparison of VWAP distance and VWAP-ADV correlation; output is discrete and rank-resolution dependent.", "VWAP距离与VWAP-均量相关的布尔比较；输出离散且依赖截面排名分辨率。"),
    "wq101_alpha65": ("Nested ADV sum/correlation warmups make coverage sensitive to newly listed symbols.", "嵌套均量和相关窗口使覆盖率对新上市标的敏感。"),
    "wq101_alpha68": ("Combines ranked high/ADV correlation with a one-bar blended price delta; can flip around wick-heavy bars.", "结合高价/均量排名相关与一根K线混合价格变化；长影线附近可能翻转。"),
    "wq101_alpha74": ("Long nested ADV window and cross-sectional correlation ranks can be redundancy-prone with volume/VWAP families.", "长嵌套均量窗口和截面相关排名可能与成交量/VWAP类因子冗余。"),
    "wq101_alpha75": ("Boolean VWAP-volume versus low-ADV correlation gate; mostly diagnostic and sensitive to universe composition.", "VWAP-成交量与低价-均量相关的布尔门控；主要作诊断且对币种池组成敏感。"),
    "wq101_alpha77": ("Nested decay and correlation branches can be sparse for newly listed symbols and may overlap VWAP crowding factors.", "嵌套衰减和相关分支对新上市标的覆盖较慢，并可能与VWAP拥挤类因子重叠。"),
    "wq101_alpha78": ("Power transforms of rank correlations compress values into a narrow positive range and can be redundancy-prone.", "排名相关的幂变换会把数值压缩到较窄正区间，容易产生冗余。"),
    "wq101_alpha83": ("Division by VWAP-close can amplify tiny intrabar basis differences; treat extreme values as diagnostic.", "除以VWAP-收盘差会放大很小的K线内基差；极端值仅作诊断。"),
    "wq101_alpha85": ("Two correlation-rank branches with ADV warmup make the factor universe- and listing-history-sensitive.", "两个相关排名分支叠加均量启动期，使因子对币种池和上市历史敏感。"),
    "wq101_alpha86": ("Boolean close-ADV/VWAP gate is discrete and may flip around bars where close is close to VWAP.", "收盘-均量/VWAP布尔门控是离散输出，在收盘接近VWAP时容易翻转。"),
    "wq101_alpha88": ("Nested time-series ranks and decay windows create a long warmup and can be sticky after regime shifts.", "嵌套时序排名和衰减窗口带来较长启动期，市场状态切换后可能较粘滞。"),
    "wq101_alpha92": ("Uses a decayed boolean candle condition; output depends on bar construction and cross-sectional ADV rank resolution.", "使用衰减布尔K线条件；输出依赖K线构造和截面均量排名分辨率。"),
    "wq101_alpha94": ("VWAP/ADV nested rank power is sensitive to stale volume windows and may be sparse for short-history symbols.", "VWAP/均量嵌套排名幂对滞后成交量窗口敏感，短历史标的可能稀疏。"),
    "wq101_alpha95": ("Boolean open-min versus ADV-correlation rank gate has long warmup and discrete output.", "开盘最低差与均量相关排名门控启动期长，且输出离散。"),
    "wq101_alpha99": ("Boolean mid-ADV versus low-volume correlation gate can be highly redundant with volume/liquidity families.", "中价-均量与低价-成交量相关门控可能与成交量/流动性因子高度冗余。"),
